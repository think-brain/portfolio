...
Hands on session of different Packages {Pandas,Numpy,Scipy) used in Data Science work for data handling , data transformation, applied numerical methods etc." />
        <SyllabusBox text="Times Series Analysis" content="This module covers the fundamentals of Time Series Analysis and detailed study of various algorithms to solve time series problems." />
      ...
      <div className="lg:flex items-center justify-evenly m-8">
        ...
        <SyllabusBox text="Project" content="50+ Hands on session,10 portfolio projects" />
      </div>
    </div>
  )
}
